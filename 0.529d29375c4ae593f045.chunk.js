...
var Service_1 = __webpack_require__("./src/app/backend-api/identity-registry/autogen/model/Service.ts");
var select_validator_1 = __webpack_require__("./src/app/theme/validators/select.validator.ts");
var mcCoverageMap_component_1 = __webpack_require__("./src/app/theme/components/mcCoverageMap/mcCoverageMap.component.ts");
var OidcAccessTypeEnum = Service_1.Service.OidcAccessTypeEnum;
var InstanceNewComponent = (function () {
    ...
    InstanceNewComponent.prototype.isXmlValid = function (file) {
        try {
            ...
            if (isValid) {
                ...
                var isWKTValid = this.isWKTValid(file);
                if (!isValid) {
    ...
    InstanceNewComponent.prototype.isWKTValid = function (file) {
        ...
        var coversAreasRoot = xmlData.getElementsByTagName('coversAreas')[0];
        var coversAreas = coversAreasRoot.getElementsByTagName('coversArea');
        console.log(coversAreas);
        var isValid = true;
        var areas = [];
        for (var i = 0; i < coversAreas.length; i++) {
            var area = coversAreas[i].getElementsByTagName('geometryAsWKT')[0].childNodes[0].nodeValue;
    ...
    __decorate([
        core_1.ViewChild(mcCoverageMap_component_1.McCoverageMap), 
        __metadata('design:type', (typeof (_b = typeof mcCoverageMap_component_1.McCoverageMap !== 'undefined' && mcCoverageMap_component_1.McCoverageMap) === 'function' && _b) || Object)
    ], InstanceNewComponent.prototype, "coverageMap", void 0);
    InstanceNewComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_c = typeof forms_1.FormBuilder !== 'undefined' && forms_1.FormBuilder) === 'function' && _c) || Object, (typeof (_d = typeof instance_xml_parser_service_1.InstanceXmlParser !== 'undefined' && instance_xml_parser_service_1.InstanceXmlParser) === 'function' && _d) || Object, (typeof (_e = typeof mrn_helper_service_1.MrnHelperService !== 'undefined' && mrn_helper_service_1.MrnHelperService) === 'function' && _e) || Object, (typeof (_f = typeof router_1.ActivatedRoute !== 'undefined' && router_1.ActivatedRoute) === 'function' && _f) || Object, (typeof (_g = typeof xml_parser_service_1.XmlParserService !== 'undefined' && xml_parser_service_1.XmlParserService) === 'function' && _g) || Object, (typeof (_h = typeof sr_view_model_service_1.SrViewModelService !== 'undefined' && sr_view_model_service_1.SrViewModelService) === 'function' && _h) || Object, (typeof (_j = typeof navigation_helper_service_1.NavigationHelperService !== 'undefined' && navigation_helper_service_1.NavigationHelperService) === 'function' && _j) || Object, (typeof (_k = typeof mc_notifications_service_1.MCNotificationsService !== 'undefined' && mc_notifications_service_1.MCNotificationsService) === 'function' && _k) || Object, (typeof (_l = typeof designs_service_1.DesignsService !== 'undefined' && designs_service_1.DesignsService) === 'function' && _l) || Object, (typeof (_m = typeof organizations_service_1.OrganizationsService !== 'undefined' && organizations_service_1.OrganizationsService) === 'function' && _m) || Object, (typeof (_o = typeof instances_service_1.InstancesService !== 'undefined' && instances_service_1.InstancesService) === 'function' && _o) || Object, (typeof (_p = typeof id_services_service_1.IdServicesService !== 'undefined' && id_services_service_1.IdServicesService) === 'function' && _p) || Object])
...
//# sourceMappingURL=0.738bf2d035b9e2d02bcf.map