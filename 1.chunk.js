...
var InstanceDetailsComponent = (function () {
    ...
    InstanceDetailsComponent.prototype.loadIdService = function (mrn) {
        var _this = this;
        this.servicesService.getIdService(mrn, this.instance.organizationId).subscribe(function (service) {
            _this.idService = service;
            _this.showUpdateIdService = (_this.isMyOrg() && _this.isAdmin()) /* TODO for now only update if my org, because updating another orgs entities is a quite different kind of woopass|| this.authService.authState.isSiteAdmin()*/;
...
var SpecificationDetailsComponent = (function () {
    function SpecificationDetailsComponent(authService, route, router, viewModelService, navigationHelperService, instancesService, notifications, specificationsService, designsService, fileHelperService, orgsService) {
        this.authService = authService;
        this.route = route;
        this.router = router;
        this.viewModelService = viewModelService;
