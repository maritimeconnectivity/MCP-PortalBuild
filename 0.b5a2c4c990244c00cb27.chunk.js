...
var DesignUpdateComponent = (function () {
    ...
    DesignUpdateComponent.prototype.updateStatus = function () {
        ...
        this.designService.updateStatus(this.design, this.status).subscribe(function (_) {
            ...
            _this.isUpdating = false;
            _this.notifications.generateNotification('Error', 'Error when trying to update status', mc_notifications_service_1.MCNotificationType.Error, err);
        });
    };
...
//# sourceMappingURL=0.002afafcce351d38a300.map