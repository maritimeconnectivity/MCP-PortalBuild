...
var DesignDetailsComponent = (function () {
    function DesignDetailsComponent(authService, route, router, viewModelService, navigationHelperService, instancesService, specificationsService, notifications, designsService, fileHelperService, orgsService) {
        this.authService = authService;
        this.route = route;
        this.router = router;
...
var InstanceDetailsComponent = (function () {
    function InstanceDetailsComponent(servicesService, authService, route, router, viewModelService, navigationHelperService, instancesService, notifications, designsService, fileHelperService, mrnHelper, docsService, orgsService) {
        this.servicesService = servicesService;
        this.authService = authService;
        this.route = route;
        this.router = router;
...
var SpecificationDetailsComponent = (function () {
    function SpecificationDetailsComponent(searchRequestsService, endorsementsService, authService, route, router, viewModelService, navigationHelperService, instancesService, notifications, specificationsService, designsService, fileHelperService, orgsService) {
    ...
    SpecificationDetailsComponent.prototype.loadEndorsements = function (specificationId) {
        var _this = this;
        ...
        return rxjs_1.Observable.forkJoin(parallelObservables).subscribe(function (resultArray) {
            ...
            _this.setEndorseButtonClassAndTitle();
        }, function (err) {
    ...
    SpecificationDetailsComponent.prototype.setEndorseButtonClassAndTitle = function () {
    ...
    SpecificationDetailsComponent.prototype.endorse = function () {
        ...
        this.endorsementsService.endorseSpecification(this.specification.specificationId).subscribe(function (_) {
            _this.isEndorsedByMyOrg = true;
            _this.setEndorseButtonClassAndTitle();
            _this.isEndorsing = false;
            _this.loadEndorsements(_this.specification.specificationId);
        }, function (err) {
            _this.isEndorsing = false;
            _this.notifications.generateNotification('Error', 'Error when trying endorse specification', mc_notifications_service_1.MCNotificationType.Error, err);
        });
    };
    SpecificationDetailsComponent.prototype.removeEndorse = function () {
        var _this = this;
        this.isEndorsing = true;
        this.endorsementsService.removeEndorsementOfSpecification(this.specification.specificationId).subscribe(function (_) {
        ...
        if (this.endorsements) {
            if (this.endorsements !== this.oldEndorsements) {
                ...
                this.endorsements.forEach(function (endorsement) {
                    var htmlContent = '&nbsp;';
                    var entityImage = { imageSourceObservable: _this.createImgObservable(endorsement.orgMrn), entityId: endorsement.orgMrn, title: endorsement.orgName, htmlContent: htmlContent };
...
var ServiceRegistrySearchComponent = (function () {
    function ServiceRegistrySearchComponent(searchRequestsService, changeDetector, authService, formBuilder, orgsService, notifications) {
        ...
        this.endorsementMainSwitch = false;
...
//# sourceMappingURL=1.b77057265af73f58e5e8.map