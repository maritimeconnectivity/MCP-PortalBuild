...
var InstanceListComponent = (function () {
    ...
    InstanceListComponent.prototype.loadInstances = function () {
        ...
        if (searchRequest) {
            ...
            this.instancesService.getInstancesForMyOrg(false).subscribe(function (instances) {
                _this.instances = instances;
                _this.isLoading = false;
            }, function (err) {
                _this.isLoading = false;
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-lg-12\">\r\n    <ba-card title=\"{{cardTitle}}\" baCardClass=\"with-scroll table-panel\">\r\n      <service-registry-search [showSimulatedOption]=\"true\" [searchTitle]=\"'Search filters'\" [searchKey]=\"searchKey\" [isSearching]=\"isSearching\" [showEndorsement]=\"true\" [preFilterMyOrg]=\"true\" (onSearch)=\"search($event)\"></service-registry-search>\r\n\r\n      <div class=\"separator\"></div>\r\n\r\n      <instances-table [instances]=\"instances\" [isLoading]=\"isLoading\" [onRowClick]=\"onGotoInstance\"></instances-table>\r\n    </ba-card>\r\n  </div>\r\n</div>\r\n"
...
var ServiceRegistrySearchComponent = (function () {
    function ServiceRegistrySearchComponent(searchRequestsService, changeDetector, authService, formBuilder, orgsService, notifications) {
        ...
        this.showSimulatedOption = false;
    ...
    ServiceRegistrySearchComponent.prototype.onSimulatedChange = function (value) {
    ...
    ServiceRegistrySearchComponent.prototype.doSearch = function (keywords, registeredBy, endorsedBy) {
        var searchRequest = { keywords: keywords, registeredBy: registeredBy, endorsedBy: endorsedBy, showOnlySimulated: this.simulatedState };
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], ServiceRegistrySearchComponent.prototype, "showSimulatedOption", void 0);
    __decorate([
        core_1.Output(), 
...
var ServicesTableComponent = (function () {
    ...
    ServicesTableComponent.prototype.generateHeadersAndRows = function () {
        var tableHeaders = [];
        var tableRows = [];
        var tableHeader = { title: 'Name', class: '' };
        tableHeaders.push(tableHeader);
...
//# sourceMappingURL=0.ce0102be10a82b4ad964.map